...
No ads, no tracking, no account, no in-app purchases. The only thing in the app that ever opens a
connection is the ROM import, and only when you type an address into it yourself.
